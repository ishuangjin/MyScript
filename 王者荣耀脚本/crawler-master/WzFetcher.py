...
class Fetcher:
    def __init__(self, openid, zone_area_id, ticket, key):
        ...
        self._headers = {
            ...
            'User-Agent' : 'Mozilla/5.0 (iPhone; CPU iPhone OS 15_4_1 like Mac OS X) AppleWebKit/605.1.15 (KHTML, like Gecko) Mobile/15E148 MicroMessenger/8.0.18(0x1800123f) NetType/WIFI Language/zh_CN WKGameHttpScheme/1',
    ...
    def get_user_info(self, zone_area_id=None):
        ...
        headers['Referer'] = 'https://game.weixin.qq.com/cgi-bin/h5/static/smobadynamic/dynamic.html?isFromWeappEntry=1&ssid=29&openid={}&abtest_cookie=AwABAAoACwAUAAMAI5ceAFeZHgCLmR4AAAA%3D&pass_ticket={}&wx_header=1'.format(
            self._openid, self._ticket)
    ...
    def get_user_hero_info(self, zone_area_id=None):
        ...
        headers = self._headers
        headers[
            'Referer'] = 'https://game.weixin.qq.com/cgi-bin/h5/static/smobadynamic/allhero.html?openid={}&zone_area_id={}&ssid=1021&uin=&key=&pass_ticket={}&abtest_cookie=AwABAAoACwAUAAMAI5ceAFeZHgCLmR4AAAA%3D&wx_header=1'.format(
            self._openid, self._zone_area_id, self._ticket)
        cookies = self._cookies
    ...
    def get_battle_info_list(self, zone_area_id=None, offset=None, limit=None):
        ...
        headers = self._headers
        headers['Referer'] = 'https://game.weixin.qq.com/cgi-bin/h5/static/smobadynamic/allbattle.html?openid={}&zone_area_id={}&ssid=1021&uin=&key=&pass_ticket={}&wx_header=1'.format(
            self._openid, self._zone_area_id, self._ticket)
        cookies = self._cookies
    ...
    def get_battle_info_detail(self, game_seq, game_svr_entity, relay_svr_entity):
        ...
        headers = self._headers
        headers[
            'Referer'] = 'https://game.weixin.qq.com/cgi-bin/h5/static/smobadynamic/index.html?game_svr_entity={}&game_seq={}&relay_svr_entity={}&openid={}&ssid=1021&abtest_cookie=AwABAAoACwAUAAMAI5ceAFeZHgCLmR4AAAA%3D&pass_ticket={}&wx_header=1'.format(
            game_svr_entity, game_seq, relay_svr_entity, self._openid, self._ticket)
        cookies = self._cookies
